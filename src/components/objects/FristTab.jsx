...
export default function FristTab() {
  ...
  return (
    <div className="max-w-[1600px] px-[50px] mx-auto">
      <div className="w-full md:px-[50px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between md:px-[30px]">
          <div className="w-full mb-[56px] flex flex-col items-center lg:items-start">
            ...
            <button className="w-[208px] px-[20px] py-[7px] flex justify-between items-center bg-[#343232] text-white">
          ...
          <div className="mx-auto gap-[10px] flex justify-center flex-wrap lg:flex-col lg:flex-nowrap">
            {lists.map((item, index) => (
              <div
                key={index}
                className="flex w-[221px] justify-between items-center mb-[20px]"
              >
                {item.svg}
                <div className="w-full ml-[20px]">
                  <p className="text-start text-[#252525] font-[600]">
                    {item.subtitle}
                  </p>
